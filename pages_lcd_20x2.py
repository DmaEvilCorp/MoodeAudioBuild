...
WIDGETS = {
	...
	'nowplayingdata': { 'type':'text', 'format':'{0} OF {1}', 'variables':['playlist_position', 'playlist_length'], 'font':'small', 'just':'right','size':(60,8),'varwidth':True},
	...
	'showplay': { 'type':'text', 'format':'\ue000 PLAY', 'font':'large', 'varwidth':True, 'just':'left', 'size':(100,16) },
	'showstop': { 'type':'text', 'format':'\ue001 STOP', 'font':'large', 'varwidth':True, 'just':'left', 'size':(100,16) },
...
CANVASES = {
	'playartist': { 'widgets': [ ('artist',0,8), ('nowplaying',0,0), ('nowplayingdata',60,0), ('songprogress',20,0) ], 'size':(100,16) },
	'playalbum': { 'widgets': [ ('album',0,8), ('nowplaying',0,0), ('nowplayingdata',60,0), ('songprogress',20,0) ], 'size':(100,16) },
	'playtitle': { 'widgets':  [ ('title',0,8), ('nowplaying',0,0), ('nowplayingdata',60,0), ('songprogress',20,0) ], 'size':(100,16) },
	'playartist_radio': { 'widgets': [ ('artist',0,8), ('nowplaying',0,0), ('radio',60,0), ('songprogress',20,0) ], 'size':(100,16) },
	'playalbum_radio': { 'widgets':  [ ('album',0,8), ('nowplaying',0,0), ('radio',60,0), ('songprogress',20,0) ], 'size':(100,16) },
	'playtitle_radio': { 'widgets':  [ ('title',0,8), ('nowplaying',0,0), ('radio',60,0), ('songprogress',20,0) ], 'size':(100,16) },
	...
	'stoptime': { 'widgets': [ ('time',10,0), ('ampm',80,0) ], 'size':(100,16) },
	'weather': { 'widgets': [ ('temp',0,0), ('conditions',0,8), ('temphilow', 75,0) ], 'size':(100,16) },
